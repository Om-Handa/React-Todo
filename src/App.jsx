        ...
        <div className='container md:w-1/2 w-full '>
          <div className="bg-[#0B3948] min-h-24 flex flex-col items-center space-y-6 p-2">
            ...
            <div className="input w-full flex space-x-4 justify-center items-center">
              <input type="text" className='rounded-lg w-3/4 p-1 h-9' value={todo} onChange={handleInput} placeholder='Enter Your Todo' />
              <button disabled={todo.length < 4} className='bg-red-900 flex justify-center items-center' onClick={handleClick}>
